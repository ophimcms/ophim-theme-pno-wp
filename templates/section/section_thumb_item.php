<div class="popup" title="<?php the_title(); ?> - {{$movie->origin_name}} ({{$movie->publish_year}})">
    <div class="latest-movie-img-container lazy"
         style="background-image: url('<?= op_get_thumb_url() ?>'); display: inline-block;">
        <div class="movie-img">
            <a href="<?php the_permalink(); ?>" class="ico-play ico-play-sm">
            ...
            <div class="video_quality_movie">
                <span class="label label-primary"> <?= op_get_episode() ?> </span>
            </div>
            <div class="movie-title">
                <h3>
                    <a href="<?php the_permalink(); ?>"><?php the_title(); ?> - <?= op_get_original_title() ?> (<?= op_get_year() ?>)</a>
                </h3>
            </div>
        </div>
    </div>
